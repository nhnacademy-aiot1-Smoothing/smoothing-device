...
public interface SensorErrorLogRepository extends JpaRepository<SensorErrorLog, Integer>{
     ...
     */
    @Query("SELECT new live.smoothing.device.sensor.dto.SensorErrorResponse(s.sensorErrorLogId ,s.sensorErrorType, s.broker.brokerName, s.sensorErrorCreatedAt, s.sensorErrorValue, s.topic.topic) FROM SensorErrorLog s")
